...
@section('head_content')
    ...
    <link type="text/css" rel="stylesheet" href="{{URL::asset('mobel/css/pinggushi.css')}}">
    <style>
        .input-border{
    ...
    <div class="popup popup-downapp js-sub-app-pub">
        ...
        <div class="popup-body">
            <div class="pop-tit">
                ...
                <p class="js-subtitle">淘车乐商学院</p>
            </div>

            <div class="form-deliver">
                <div class="fl">
                    <p class="downapp">二手车（中、高级）鉴定评估师特训班招生啦!</p>
                </div>
...
@section('script_content')
    ...
    {{-- <script src="{{URL::asset('mobel/js/wx.js')}}"></script> --}}
    <script>
