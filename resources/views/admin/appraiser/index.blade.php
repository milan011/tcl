...
@include('layouts.message')
    					...
    					<tr>
							...
							<td class="center">
								...
								<div class="btn-group">
									...
									<li>
										<a class="btn btn-success" href="{{route('admin.appraiser.edit', ['appraiser'=>$car->id])}}">
										<i class="icon-edit icon-white"></i> 评估
										</a>												
									</li>
								</div>
	...
	<div class="modal hide fade" id="myModal">
		...
		<div class="modal-body"">
			<form class="form-horizontal" id="condition" action="{{route('admin.appraiser.index')}}/index" method="post">
				{!! csrf_field() !!}
				<fieldset>
					...
					<div class="control-group  ">
            	    	<label class="control-label" for="is_appraiser">车源状态</label>
            	    	<div class="controls">
            	      		<select id="is_appraiser" name="is_appraiser" >                       					
								<option @if($select_conditions['is_appraiser'] == '1' && $select_conditions['is_appraiser'] != '') selected @endif value="1">已评估
								</option>
								<option @if($select_conditions['is_appraiser'] == '2' && $select_conditions['is_appraiser'] != '') selected @endif value="2">未评估
								</option>	                   
            	      		</select>
            	    	</div>
            	  	</div>
