...
@section('content')
    ...
    <section class="carDetail dib-con container" style="margin-top:5px;">
        <div style="font-size: 16px;background: #f0f0f0;padding: 20px 37px 20px;line-height:30pt;">
            ...
            <p>
                <span style="font-size:16px;letter-spacing: 1px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 河北淘车乐二手车交易有限公司成立于2011年9月，公司以“诚实信用  合作共赢，透明交易，连锁经营”的理念，打破传统的二手车交易模式，配以旗下“定盘星”二手车鉴定评估有限公司，一站式服务，让买车卖车更加便捷放心。五年多的时间，公司累计销售二手车十几万辆，现已建立了网上销售平台—淘车乐官方网站,并成立淘车乐二手车服务中心，加盟连锁店接近60家，客户遍布北京、河北、新疆、浙江、吉林、黑龙江、山西、陕西等多个省份并与荣华集团、广汇集团、晨阳集团、冀中合力等旗下数十家4S店进行深度合作，实现了线上线下的有效结合。</span> 
            </p>
        </div>
        <div style="font-size: 16px;background: #f0f0f0;padding: 20px 37px 20px;line-height:30pt;">
            <p>
            ...
            <p>
                <span style="font-size:16px;letter-spacing: 1px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 透明交易  全国连锁   我们的理念： 诚实信用  合作共赢。</span> 
            </p>
        </div>
        <div style="font-size: 16px;background: #f0f0f0;padding: 20px 37px 20px;line-height:30pt;">
            <p>
            ...
            <p>
                <span style="font-size:16px;letter-spacing: 1px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 打造全国最大、最好、最具特色的二手车交易服务平台！</span> 
            </p>
        </div>
        <div style="font-size: 16px;background: #f0f0f0;padding: 20px 37px 20px;line-height:30pt;">
            <p>
        ...
        <div style="font-size: 16px;background: #f0f0f0;padding: 20px 37px 20px;line-height:30pt;">
            ...
            <p>
                <span style="font-size:16px;letter-spacing: 1px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1.执照资质全：淘车乐公司是河北省内知名的二手车交易平台，起步比较早，资质比较全。目前淘车乐是河北省内唯一的中国人民共和国商务部商业特许经营备案的二手车交易企业。
