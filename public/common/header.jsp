					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								<i class="halflings-icon white user"></i> ${loginUsrDTO.realName }
							...
							<ul class="dropdown-menu">
								...
								<li><a href="${ctx }/usr/main/pwd?id=${loginUsrDTO.dept}&name=${loginUsrDTO.loginName}"><i class="halflings-icon user"></i>修改密码</a></li>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<c:forEach items="${modelList }" var="children">
							<li><a class="submenu"href="${ctx }/${children.url }">
									<i class="${children.icon }"></i> <span class="hidden-tablet">
										${children.name }</span>
							</a></li>
