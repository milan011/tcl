...
["Header 3","<h3>"],["Header 4","<h4>"],["Header 5","<h5>"],["Header 6","<h6>"]],useCSS:false,docType:'<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">',docCSSFile:"",bodyStyle:"margin:4px; font:10pt Arial,Verdana; cursor:text"},buttons:{init:"bold,加粗,|italic,斜体,|underline,下划线,|strikethrough,删除线,|subscript,下标,|superscript,上标,|font,字体,fontname,|size,字号,fontsize,|style,样式,formatblock,|color,字体颜色,forecolor,|highlight,高亮,hilitecolor,color|removeformat,删除格式,|bullets,列表,insertunorderedlist|numbering,数字列表,insertorderedlist|outdent,缩进,|indent,取消缩进,|alignleft,左对齐,justifyleft|center,居中对齐,justifycenter|alignright,右对齐,justifyright|justify,分散对齐,justifyfull|undo,撤销,|redo,重复操作,|rule,插入分割线,inserthorizontalrule|image,插入图片,insertimage,url|link,插入超链接,createlink,url|unlink,删除超链接,|cut,剪切,|copy,复制,|paste,粘贴,|pastetext,只粘贴文本,inserthtml,|print,打印,|source,源代码"},
