...
namespace App\Http\Controllers\Mobel\Auth;
...
class WxAuthController extends Controller
{
    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        return redirect('/manage')->withInput($request->except('password'))->with('msg', '用户名或密码错误')->withErrors('用户名或密码错误');
    }
